...
import AgentNav from "~/components/layout/sidebar/agent-nav";
...
function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="w-full flex relative">
      ...
      <div
        className={`w-full lg:ml-[425px] mt-[60px] relative`}
        // style={{ marginLeft: isLargeScreen ? `${sidebarWidth + 145}px` : 0 }}
      >
        {children}
      </div>
    </div>
