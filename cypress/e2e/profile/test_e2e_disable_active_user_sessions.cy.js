describe("e2e tests for disable active user sessions", () => {
  it("verify disable active user sessions", () => {
    ...
    //Verify disable active user sessions
    cy.get("table").contains("td", "Disable").click();
